...
export class FixEntities1683123174873 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "car" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "brand" character varying NOT NULL, "frontImg" character varying(400) NOT NULL, "model" character varying(50) NOT NULL, "fuel" character varying(50) NOT NULL, "year" character varying NOT NULL, "mileage" integer NOT NULL, "description" character varying NOT NULL, "price" integer NOT NULL, "priceFipe" character varying NOT NULL, "color" character varying(20) NOT NULL, "goodDeal" boolean NOT NULL DEFAULT false, "isPublished" boolean NOT NULL DEFAULT true, "userId" uuid, CONSTRAINT "PK_55bbdeb14e0b1d7ab417d11ee6d" PRIMARY KEY ("id"))`);
